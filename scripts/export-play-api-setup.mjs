...
const lines = [
  ...
  "- **已完成**：SA 已邀請；`pnpm check:play-api` → `apiAccessOk=true`（probe=`oneTimeProducts`）",
  "",
  ...
  "```",
  "",
  "預期：`android.playApi: true`、`androidProductionReady: true`；全平台 `productionReady: true` 另需 Apple IAP 憑證",
  "",
  "## 4. Play Console 捷徑",
  "",
